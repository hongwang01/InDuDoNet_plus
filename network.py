"""
The extension of MICCAI2021: ``InDuDoNet: An Interpretable Dual Domain Network for CT Metal Artifact Reduction''
paper link：
"""
import os
import torch
...
class InDuDoNet_plus (nn.Module):
    def __init__(self, args):
        super(InDuDoNet_plus, self).__init__()
    ...
    def forward(self, Xma, XLI, M, Sma, SLI, Tr, Xprior):
